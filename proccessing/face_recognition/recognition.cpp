...
double recognition::calculateAccuracy(const Mat &y_pred, const Mat &Y_test)
{
...
double recognition::getClassFromName(string name)
{
...
void recognition::train_test_split(vector<vector<double>> x, vector<double> y, float train_ratio, int seed, vector<vector<double>> &xTrain, vector<vector<double>> &xTest, vector<double> &yTrain, vector<double> &yTest)
{
...
vector<double> recognition::flatten(cv::Mat image)
{
